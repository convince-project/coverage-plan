/**
 * Experiment for ICAPS which tests the speed of learning.
 *
...
void runGroundTruth() {
  ...
  writeResults(
      results,
      "../../data/results/icaps_exps/learning/ground_truth_results.csv");
}
...
void runDifferentEstimates() {
  ...
  for (const ParameterEstimate &method : methods) {
    ...
    if (method == ParameterEstimate::posteriorSample) {
      writeResults(results, "../../data/results/icaps_exps/learning/"
                            "posterior_sample_results.csv");
      writeResults(imacErrors, "../../data/results/icaps_exps/learning/"
                               "posterior_sample_imac_errors.csv");
    } else if (method == ParameterEstimate::posteriorMean) {
      writeResults(
          results,
          "../../data/results/icaps_exps/learning/posterior_mean_results.csv");
      writeResults(imacErrors, "../../data/results/icaps_exps/learning/"
