...
TEST_CASE("Tests for initialisation BIMac constructor", "[BIMac]") {
  ...
  obsVec.push_back(BIMacObservation{GridCell{0, 0}, 0, 2, 2, 0, 0, 2});
  obsVec.push_back(BIMacObservation{GridCell{2, 0}, 0, 2, 2, 0, 2, 0});
...
TEST_CASE("Tests for reading and writing BIMac objects", "[readWrite]") {
  ...
  std::vector<BIMacObservation> obsVec{};
  obsVec.push_back(BIMacObservation{GridCell{0, 0}, 0, 2, 2, 0, 0, 2});
  obsVec.push_back(BIMacObservation{GridCell{1, 0}, 1, 3, 1, 4, 2, 1});
  obsVec.push_back(BIMacObservation{GridCell{2, 0}, 10, 25, 17, 18, 6, 0});
  obsVec.push_back(BIMacObservation{GridCell{0, 1}, 20, 4, 7, 9, 2, 6});
  obsVec.push_back(BIMacObservation{GridCell{1, 1}, 1, 1, 1, 1, 5, 13});
  obsVec.push_back(BIMacObservation{GridCell{2, 1}, 5, 6, 7, 8, 4, 4});
  bimac->updatePosterior(obsVec);
...
TEST_CASE("Tests for posterior update", "[updatePosterior]") {
  ...
  std::vector<BIMacObservation> obsVec{};
  obsVec.push_back(BIMacObservation{GridCell{0, 0}, 0, 2, 2, 0, 0, 2});
  obsVec.push_back(BIMacObservation{GridCell{1, 0}, 0, 3, 0, 3, 2, 1});
  obsVec.push_back(BIMacObservation{GridCell{2, 0}, 0, 2, 2, 0, 6, 0});
  obsVec.push_back(BIMacObservation{GridCell{0, 1}, 1, 2, 2, 1, 2, 6});
  obsVec.push_back(BIMacObservation{GridCell{1, 1}, 3, 3, 4, 2, 5, 13});
  obsVec.push_back(BIMacObservation{GridCell{2, 1}, 5, 3, 1, 7, 4, 4});
  bimac->updatePosterior(obsVec);
...
TEST_CASE("Tests for posterior mean", "[posteriorMean]") {
  ...
  obsVec.push_back(BIMacObservation{GridCell{0, 0}, 0, 2, 2, 0, 0, 2});
  obsVec.push_back(BIMacObservation{GridCell{1, 0}, 0, 3, 0, 3, 2, 1});
  obsVec.push_back(BIMacObservation{GridCell{2, 0}, 4, 14, 3, 5, 6, 0});
  obsVec.push_back(BIMacObservation{GridCell{0, 1}, 1, 2, 2, 1, 2, 6});
  obsVec.push_back(BIMacObservation{GridCell{1, 1}, 3, 3, 4, 2, 5, 13});
  obsVec.push_back(BIMacObservation{GridCell{2, 1}, 5, 3, 1, 7, 4, 4});
  bimac->updatePosterior(obsVec);
...
TEST_CASE("Tests for mle", "[mle]") {
  ...
  // Add some observations and try this again
  std::vector<BIMacObservation> obsVec{};
  obsVec.push_back(BIMacObservation{GridCell{0, 0}, 1, 3, 3, 1, 1, 3});
  obsVec.push_back(BIMacObservation{GridCell{1, 0}, 1, 4, 1, 4, 3, 2});
  obsVec.push_back(BIMacObservation{GridCell{2, 0}, 5, 15, 4, 6, 7, 1});
  obsVec.push_back(BIMacObservation{GridCell{0, 1}, 2, 3, 3, 2, 3, 7});
  obsVec.push_back(BIMacObservation{GridCell{1, 1}, 4, 4, 5, 3, 6, 14});
  obsVec.push_back(BIMacObservation{GridCell{2, 1}, 6, 4, 2, 8, 5, 5});
  bimac->updatePosterior(obsVec);
...
TEST_CASE("Tests for posterior sample", "[posteriorSample]") {
  ...
  std::vector<BIMacObservation> obsVec{};
  obsVec.push_back(
      BIMacObservation{GridCell{0, 0}, 10000, 0, 0, 10000, 0, 10000});
  obsVec.push_back(
      BIMacObservation{GridCell{1, 0}, 10000, 0, 0, 10000, 0, 10000});
  obsVec.push_back(
      BIMacObservation{GridCell{2, 0}, 10000, 0, 0, 10000, 0, 10000});
  obsVec.push_back(
      BIMacObservation{GridCell{0, 1}, 10000, 0, 0, 10000, 0, 10000});
  obsVec.push_back(
      BIMacObservation{GridCell{1, 1}, 10000, 0, 0, 10000, 0, 10000});
  obsVec.push_back(
      BIMacObservation{GridCell{2, 1}, 10000, 0, 0, 10000, 0, 10000});
  bimac->updatePosterior(obsVec);
