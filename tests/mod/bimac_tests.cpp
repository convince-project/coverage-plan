...
TEST_CASE("Tests for initialisation BIMac constructor", "[BIMac]") {
  ...
  std::unique_ptr<BIMac> bimac{std::make_unique<BIMac>(2, 3)};
  ...
  obsVec.push_back(BIMacObservation{0, 2, 0, 2, 2, 0});
...
TEST_CASE("Tests for reading and writing BIMac objects", "[readWrite]") {
  ...
  std::vector<BIMacObservation> obsVec{};
  obsVec.push_back(BIMacObservation{0, 0, 0, 2, 2, 0});
  obsVec.push_back(BIMacObservation{0, 1, 1, 3, 1, 4});
  obsVec.push_back(BIMacObservation{0, 2, 10, 25, 17, 18});
  obsVec.push_back(BIMacObservation{1, 0, 20, 4, 7, 9});
  obsVec.push_back(BIMacObservation{1, 1, 1, 1, 1, 1});
  obsVec.push_back(BIMacObservation{1, 2, 5, 6, 7, 8});
  bimac->updatePosterior(obsVec);
...
TEST_CASE("Tests for posterior update", "[updatePosterior]") {
  ...
  std::vector<BIMacObservation> obsVec{};
  obsVec.push_back(BIMacObservation{0, 0, 0, 2, 2, 0});
  obsVec.push_back(BIMacObservation{0, 1, 0, 3, 0, 3});
  obsVec.push_back(BIMacObservation{0, 2, 0, 2, 2, 0});
  obsVec.push_back(BIMacObservation{1, 0, 1, 2, 2, 1});
  obsVec.push_back(BIMacObservation{1, 1, 3, 3, 4, 2});
  obsVec.push_back(BIMacObservation{1, 2, 5, 3, 1, 7});
  bimac->updatePosterior(obsVec);
...
TEST_CASE("Tests for posterior mean", "[posteriorMean]") {
  ...
  obsVec.push_back(BIMacObservation{0, 0, 0, 2, 2, 0});
  obsVec.push_back(BIMacObservation{0, 1, 0, 3, 0, 3});
  obsVec.push_back(BIMacObservation{0, 2, 4, 14, 3, 5});
  obsVec.push_back(BIMacObservation{1, 0, 1, 2, 2, 1});
  obsVec.push_back(BIMacObservation{1, 1, 3, 3, 4, 2});
  obsVec.push_back(BIMacObservation{1, 2, 5, 3, 1, 7});
  bimac->updatePosterior(obsVec);
...
TEST_CASE("Tests for mle", "[mle]") {
  ...
  obsVec.push_back(BIMacObservation{0, 1, 1, 4, 1, 4});
  obsVec.push_back(BIMacObservation{0, 2, 5, 15, 4, 6});
  obsVec.push_back(BIMacObservation{1, 0, 2, 3, 3, 2});
  obsVec.push_back(BIMacObservation{1, 1, 4, 4, 5, 3});
  obsVec.push_back(BIMacObservation{1, 2, 6, 4, 2, 8});
  bimac->updatePosterior(obsVec);
...
TEST_CASE("Tests for posterior sample", "[posteriorSample]") {
  ...
  obsVec.push_back(BIMacObservation{0, 2, 10000, 0, 0, 10000});
  obsVec.push_back(BIMacObservation{1, 0, 10000, 0, 0, 10000});
  obsVec.push_back(BIMacObservation{1, 1, 10000, 0, 0, 10000});
  obsVec.push_back(BIMacObservation{1, 2, 10000, 0, 0, 10000});
  bimac->updatePosterior(obsVec);
